...
var map_AWSKMSConfig = map[string]string{
	...
	"keyARN": "keyARN is the AWS ARN for the symmetric encryption KMS key",
	"region": "region is the AWS region where the KMS instance exists",
}
...
var map_KMSConfig = map[string]string{
	"":    "KMSConfig defines the configuration for the KMS instance that will be used with KMSv2 encryption",
